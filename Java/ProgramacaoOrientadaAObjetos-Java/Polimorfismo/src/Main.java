...
public class Main {
	...
	public static void main(String[] args) {
		...
		Pokemon p1 = new Pikachu("Pikachu", "Elétrico", "Choque do Trovão", 100, "Cauda de Ferro");
		
		Pokemon p2 = new Bulbassauro("Bulbassauro", "Planta", "Chicotes de Vinha", 98, "Folhas de Navalha");
		
		Pokemon p3 = new Charmander("Charmander", "Fogo", "Presas de Fogo", 99, "Lança-Chamas");
	
		Pokemon p4 = new Squirtle("Squirtle", "Água", "Rajada de Bolhas", 97, "Jato d'água");
